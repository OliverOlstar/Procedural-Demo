...
namespace OliverLoescher.Camera
{
    public class FirstPersonHandsInertia : MonoBehaviour
    {
        ...
        private void LateUpdate() 
        {
            ...
            rot.y = Calculate(Util.Func.SafeAngle(rot.y), motion.y * tiltMagnitude.x, tiltMax.x, tiltDampening.x);
            rot.x = Calculate(Util.Func.SafeAngle(rot.x), motion.x * tiltMagnitude.y, tiltMax.y, tiltDampening.y);
