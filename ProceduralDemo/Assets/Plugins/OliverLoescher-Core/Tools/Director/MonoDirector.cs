...
namespace OCore
{
	public static class MonoDirector
	{
		...
		{
			return TryGet(out T obj) ? obj : throw new System.ArgumentNullException($"OCore.MonoDirector.Get() No director of type {typeof(T).Name} exists");
		}
		...
		{
			return TryGetRecursive(out T obj) ? obj : throw new System.ArgumentNullException($"OCore.GetRecursive.Get() No director assignable from type {typeof(T).Name} exists");
		}
