...
public class AssetPickerRenameWindow : EditorWindow
{
	public static void Open(Object obj, System.Type assetType, Vector2 position)
	{
		...
		string[] paths = OCore.AssetDatabaseUtil.Find(assetType);
		List<Object> assets = new();
		OCore.AssetDatabaseUtil.LoadAll(assetType, assets);
	...
	private void OnGUI()
	{
		...
		itemRect = OCore.PropertyDrawerUtil.IndentRect(itemRect);
