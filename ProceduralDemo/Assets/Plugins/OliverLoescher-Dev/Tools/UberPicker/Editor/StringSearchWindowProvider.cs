...
namespace ODev.Picker
{
	public struct StringSearchWindowContext : IAssetPickerAttribute, IAssetPickerPathSource
	{
		...
		private readonly bool m_DoCachePaths;
		private readonly string m_Title;
		private readonly Func<List<string>> m_GetPaths;
		private readonly char[] m_PathSeperators;
		private readonly bool m_AllowNull;
		private readonly bool m_ForceFlatten;
