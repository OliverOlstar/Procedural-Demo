...
namespace ODev.Data
{
	public abstract class DataSourceBase : DBSO
	{
		...
		{
			List<System.Type> dependences = ListPool<System.Type>.Get();
			AddDependencies(dependences);
			HashSet<System.Type> dependenciesSet = HashSetPool<System.Type>.Get();
			...
			if (!import)
			{
				HashSetPool<System.Type>.Release(dependenciesSet);
				return false;
			}

			message += $"Generating {typeName} because dependencies were dirty: [{Str.Finish()}]\n";
