...
namespace ODev.Util
{
	public static class AssetDatabase
	{
		...
		private class Cache
		{
			...
			private readonly bool m_Nested = false;
		...
		private static readonly Dictionary<System.Type, Cache> s_SearchResults = new();
		...
		public static string[] FindAll(System.Type assetType)
		{
			return FindInternal(assetType).Paths;
		}
		
		public static string[] FindAll(System.Type[] assetTypes)
		{
			return assetTypes.SelectMany(t => FindInternal(t).Paths).ToArray();
		}
		...
		public static bool Exists(string assetName, System.Type[] assetTypes)
		{
