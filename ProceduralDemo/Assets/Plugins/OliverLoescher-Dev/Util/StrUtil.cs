...
namespace ODev.Util
{
    public class Str
    {
        ...
        private const int MAX_CAPACITY = 250000;
        ...
        private static readonly StringBuilder s_BuildBuilder = new();
        ...
        private static readonly StringBuilder s_AddBuilder = new();
        ...
        public static string EditorFinish()
        {
            ...
            if (s_AddBuilder != null)
            {
                ...
                s_AddBuilder.Clear();
                s_AddBuilder.Capacity = Mathf.Min(s_AddBuilder.Capacity, DEFAULT_CAPACITY);
            }
            return finish;
        }
#endif
        public static bool IsCapacityOver()
        {
            return s_AddBuilder.Capacity > MAX_CAPACITY && Application.isPlaying;
        }
        ...
        public static string Finish()
        {
            ...
            if (s_AddBuilder != null)
            {
                ...
                if (s_AddBuilder.Capacity > MAX_CAPACITY && Application.isPlaying)
                {
                    typeof(Str).DevException(new System.Exception($"[Core.Str].Finish() StringBuilder capacity ({s_AddBuilder.Capacity}) exceeded the max capacity ({MAX_CAPACITY}). This is bad for memory."));
                }
                s_AddBuilder.Capacity = Mathf.Min(s_AddBuilder.Capacity, DEFAULT_CAPACITY);
            }
            return finish;
