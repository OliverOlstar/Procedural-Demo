	...
	public static class Str
	{
		...
		public static string Finish()
		{
			...
			if (s_AddBuilder != null)
			{
				...
				{
					Debug.LogException(new System.Exception($"[Core.Str].Finish() StringBuilder capacity ({s_AddBuilder.Capacity}) exceeded the max capacity ({MAX_CAPACITY}). This is bad for memory."));
				}
				s_AddBuilder.Capacity = Mathf.Min(s_AddBuilder.Capacity, DEFAULT_CAPACITY);
			}
			return finish;
