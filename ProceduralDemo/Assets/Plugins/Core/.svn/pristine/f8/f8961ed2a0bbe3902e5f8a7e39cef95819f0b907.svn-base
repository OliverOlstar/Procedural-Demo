...
namespace Core
{
	public class TimeScaleManager : MonoBehaviour 
	{
		...
		public static TimeScaleManager GetOrCreate()
		{
			if (s_Singleton == null)
			{
				s_Singleton = new GameObject("TimeScaleManager").AddComponent<TimeScaleManager>();
		...
		public static float GetBaseTimeScale()
		{
			...
			if (tem == null)
			{
				Debug.LogWarning("TimeScaleManager.GetBaseTimeScale: TimeScaleManager is null.");
				return 1.0f;
			}
		...
		public static float GetAudioTimeScale()
		{
			...
			if ( tem == null )
			{
				Debug.LogWarning( "TimeScaleManager.GetAudioTimeScale: TimeScaleManager is null." );
				return 1.0f;
			}
		...
		public static void EndAllTimeEvents()
		{
			...
			if (tem == null)
			{
				Debug.LogWarning("TimeScaleManager.StartTimeEvent: TimeScaleManager is null.");
				return;
			}
