...
namespace Core
{
	public static class UIUtil
	{
		...
		public static void StretchToParentSize(this RectTransform rect)
		{
		...
		public static void PositionTopCenter(this RectTransform rect)
		{
		...
		public static void ScrollVerticalToBottom(this ScrollRect scrollRect)
		{
			scrollRect.normalizedPosition = new Vector2(0, 0);
		}
		
		public static void ScrollVerticalToTop(this ScrollRect scrollRect)
		{
